...
class VideoWorshipPlaceModel extends Model
{
    protected $DBGroup          = 'default';
    protected $table            = 'video_worship_place';
    protected $primaryKey       = 'id';
    protected $returnType       = 'array';
    protected $allowedFields    = ['id', 'rumah_gadang_id', 'url', 'duration', 'view'];
    ...
    public function get_video_api($worship_place_id = null) {
